...
| `nest/letter-paper-tl.png` | 65×210 | 9 KB | 无好友小窝信纸九宫格左上角 |
| `nest/letter-paper-tc.png` | 439×210 | 35 KB | 信纸九宫格顶带（含信封翻盖与图钉，切线过其下方纸面净区，固定不拉伸） |
| `nest/letter-paper-tr.png` | 216×210 | 20 KB | 信纸九宫格右上角（含木夹与翻盖） |
| `nest/letter-paper-ml.png` | 65×86 | 5 KB | 信纸九宫格左边条（纯竖向边带，随中行纵向拉伸） |
| `nest/letter-paper-mc.png` | 439×86 | 11 KB | 信纸九宫格中心净区（纯色纸面，随卡片高度纵向拉伸） |
| `nest/letter-paper-mr.png` | 216×86 | 8 KB | 信纸九宫格右边条（纯竖向边带，随中行纵向拉伸） |
| `nest/letter-paper-bl.png` | 65×253 | 12 KB | 信纸九宫格左下角 |
| `nest/letter-paper-bc.png` | 439×253 | 34 KB | 信纸九宫格底带（切线过爪印上方纸面净区，固定不拉伸） |
| `nest/letter-paper-br-v2.png` | 216×253 | 7 KB | 信纸九宫格右下角（含爪印、爱心与小信封装饰） |
