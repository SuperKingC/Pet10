...
const GARMENTS = {
  ...
  overalls: `参考图是一只手绘水彩风格的小狗穿着蓝色牛仔背带裤的正面立绘。请把这条背带裤从小狗身上脱下来单独画：彻底去掉小狗——没有毛发、没有爪子、没有脸、没有耳朵、没有尾巴；只画这条背带裤本身，保持它穿在身上的正面视角（像穿在一个看不见的身体上），两条肩带向上竖起、胸前口袋带白色小骨头图案、棕色圆纽扣，裤腿自然垂下。${COMMON_TAIL}`,
