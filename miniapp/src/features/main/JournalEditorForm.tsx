...
const moodImages: Record<string, string> = {
  happy: require('../../assets/moods/mood-3-v7.png'),
  calm: require('../../assets/moods/mood-2-v7.png'),
  sad: require('../../assets/moods/mood-1-v7.png'),
  excited: require('../../assets/moods/mood-4-v7.png'),
}
