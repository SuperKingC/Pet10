...
const moodImages: Record<string, string> = {
  happy: require('../../assets/moods/mood-3-v3.png'),
  calm: require('../../assets/moods/mood-2-v3.png'),
  sad: require('../../assets/moods/mood-1-v3.png'),
  excited: require('../../assets/moods/mood-4-v3.png'),
}
