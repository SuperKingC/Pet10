...
describe('miniapp ui presentation rules', () => {
  ...
  it('presents the journal tab with sliced puppy photos and photo-replace actions', () => {
    ...
    expect(form).toContain('moods/mood-1-v6.png')
    expect(form).toContain('moods/mood-2-v6.png')
    expect(form).toContain('moods/mood-3-v6.png')
    expect(form).toContain('moods/mood-4-v6.png')
    ...
    expect(manifest).toContain('moods/mood-1-v6.png')
    expect(manifest).toContain('moods/mood-2-v6.png')
    expect(manifest).toContain('moods/mood-3-v6.png')
