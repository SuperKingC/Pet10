...
describe('miniapp ui presentation rules', () => {
  ...
  it('opens the games hub as a full page with gobang and a coming-soon hint', () => {
    ...
    expect(gamesPage).toContain('gobang.webp')
  ...
  it('shows codeword, game and tarot icon entries in the paw menu and removes the footprint map entry', () => {
    ...
    expect(menu).toContain('codeword.webp')
    expect(menu).toContain('game.png')
    expect(menu).toContain('tarot.webp')
  ...
  it('uses the letter-paper nine-slice tiles for the nest empty-friend letter card', () => {
    ...
    expect(component).toContain('letter-paper-mc.webp')
    expect(component).toContain('letter-paper-br-v2.webp')
    ...
    expect(manifest).toContain('nest/letter-paper-br-v2.webp')
  ...
  it('presents the journal tab with sliced puppy photos and photo-replace actions', () => {
    ...
    expect(component).toContain('polaroid-sit.webp')
    expect(component).not.toContain('polaroid-run')
    expect(component).toContain('action-write.webp')
    expect(component).toContain('action-photo.webp')
    ...
    expect(form).toContain('polaroid-run.webp')
    expect(form).toContain('replacePrimaryPhoto')
    expect(form).toContain('editor-yard.webp')
    expect(form).toContain('moods/mood-1.webp')
    expect(form).toContain('moods/mood-2.webp')
    expect(form).toContain('moods/mood-3.webp')
    expect(form).toContain('moods/mood-4.webp')
    ...
    expect(form).not.toContain('puppy-cushion.webp')
    ...
    expect(manifest).toContain('journal/polaroid-run.webp')
    expect(manifest).toContain('journal/polaroid-sit.webp')
    expect(manifest).toContain('journal/action-photo.webp')
    expect(manifest).toContain('journal/action-write.webp')
    expect(manifest).toContain('journal/editor-yard.webp')
    expect(manifest).toContain('moods/mood-1.webp')
    expect(manifest).toContain('moods/mood-2.webp')
    expect(manifest).toContain('moods/mood-3.webp')
    expect(manifest).toContain('moods/mood-4.webp')
  })
  ...
  it('presents the message tab empty state with an invite illustration and share action', () => {
    ...
    expect(component).toContain('messages-empty.webp')
    ...
    expect(manifest).toContain('messages-empty.webp')
  ...
  it('shows a locked box scene and unlock button after a friend accepts the invitation', () => {
    ...
    expect(scene).toContain('xiaoduoli-box.webp')
    expect(scene).toContain('xiaoduoli-body.webp')
    expect(scene).toContain('xiaoduoli-eyes.webp')
    ...
    expect(styles).toContain('@media (prefers-reduced-motion: reduce)')
    expect(manifest).toContain('nest/xiaoduoli-box.webp')
    expect(manifest).toContain('nest/xiaoduoli-body.webp')
    expect(manifest).toContain('nest/xiaoduoli-eyes.webp')
  ...
  it('backdrops the locked box scene with the night-street illustration', () => {
    ...
    const styles = fs.readFileSync(path.resolve(__dirname, 'XiaoduoliBoxScene.scss'), 'utf8')
    const manifest = fs.readFileSync(path.resolve(__dirname, '../../../../docs/assets/asset-manifest.json'), 'utf8')
    const streetAssetPath = path.resolve(__dirname, '../../assets/nest/xiaoduoli-street-v4.webp')
    const singleAssetBudget = 180 * 1024

    expect(scene).toContain('xiaoduoli-street-v4.webp')
    ...
    expect(manifest).toContain('nest/xiaoduoli-street-v4.webp')
  ...
  it('builds the box-scene eye rig layers from the original peek artwork', () => {
    ...
    expect(manifest).toContain('nest/xiaoduoli-lids.webp')
  })
})
