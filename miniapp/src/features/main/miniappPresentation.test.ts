...
describe('miniapp ui presentation rules', () => {
  ...
  it('presents the journal tab with sliced puppy photos and photo-replace actions', () => {
    ...
    expect(form).toContain('moods/mood-1-v2.png')
    expect(form).toContain('moods/mood-2-v2.png')
    expect(form).toContain('moods/mood-3-v2.png')
    expect(form).toContain('moods/mood-4-v2.png')
    ...
    expect(manifest).toContain('moods/mood-1-v2.png')
    expect(manifest).toContain('moods/mood-2-v2.png')
    expect(manifest).toContain('moods/mood-3-v2.png')
    expect(manifest).toContain('moods/mood-4-v2.png')
  })
  ...
  it('backdrops the locked box scene with the night-street illustration', () => {
    ...
    const styles = fs.readFileSync(path.resolve(__dirname, 'XiaoduoliBoxScene.scss'), 'utf8')
    const manifest = fs.readFileSync(path.resolve(__dirname, '../../../../docs/assets/asset-manifest.json'), 'utf8')
    const streetAssetPath = path.resolve(__dirname, '../../assets/nest/xiaoduoli-street-v11.png')
    const singleAssetBudget = 180 * 1024

    expect(scene).toContain('xiaoduoli-street-v11.png')
    ...
    expect(manifest).toContain('nest/xiaoduoli-street-v11.png')
