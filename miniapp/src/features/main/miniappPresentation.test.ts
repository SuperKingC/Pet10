...
describe('miniapp ui presentation rules', () => {
  ...
  it('uses the letter-paper nine-slice tiles for the nest empty-friend letter card', () => {
    ...
    expect(component).toContain('letter-paper-tl-v2.png')
    expect(component).toContain('letter-paper-mc-v2.png')
    expect(component).toContain('letter-paper-br-v3.png')
    ...
    expect(manifest).toContain('nest/letter-paper-tl-v2.png')
    expect(manifest).toContain('nest/letter-paper-br-v3.png')
